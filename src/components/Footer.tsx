...
export default function Footer() {
  return (
    <footer className="relative border-t border-[#262626]">
      {/* Top glow */}
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-[#1A1A1A] flex items-center justify-center text-[#A1A1AA] hover:text-[#8B5CF6] hover:bg-[#8B5CF6]/10 transition-colors"
        ...
        <div className="pt-8 border-t border-[#262626] flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[#A1A1AA] text-sm flex items-center gap-1">
            ...
            <a 
              ...
              className="text-[#8B5CF6] hover:text-[#C4B5FD] transition-colors underline underline-offset-2"
            >
              Cyriac Zeh
            </a>{" "}
            a Night Owl.
